...
mPath = "model_4_2_CModelCheckpoint_best.hdf5"
m = load_model(mPath)
...
# ============================================================================ #
arm = ArmDemo()
# vrep.simxLoadScene(arm.clientID, 'C:\\Users\\matsumoto\\VREP_stage1\\armDemo_stage1_0.0.7_natural.ttt', 0, vrep.simx_opmode_blocking)
...
for iRun in range(nRun):
    ...
    # create obj
    h_objs = npa(arm.createRandomObj(nObj, isVisible=False))
    waitSecs(1)
    h_objs = removeOutOfBoxObjs(arm.clientID, h_objs, xBound2, yBound2)
    arm.setObjVisibility(h_objs, True)
