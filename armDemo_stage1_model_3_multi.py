...
gaussFilter = 4
d_train = loadData(range(0, 7000), dataPath, runID, gaussFilter)
...
#                                   Training                                   #
# ============================================================================ #
p = keras_ext.Pipeline('armDemo_stage1', 'model_3')
p.m = m
p.d_train = d_train
# p.save()
p.fit(batch_size=32, epochs=1000, validation_split=0.2)
